                        ...
                        <div class="tab-pane fade show p-0 active">
                            <div class="job-item p-4 mb-4">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-4 d-flex flex-column align-items-start align-items-md-end justify-content-center">
                                        <iframe width="450" height="280" src="<?php echo $row['skill']; ?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                       </div>
                                </div>
                            </div> 
                            <div class="col-md-6 d-flex flex-column align-items-start align-items-md-end justify-content-center">
              ...
              <div class="modal-body">
                <form method="post" action="candidate-apply.php" id="modal-details">
                  <div class="mb-2">
                    ...
                    <input type="text" class="form-control" name="courseid" id="recipient-name" readonly>
                  </div>
                  <div class="mb-2">
